    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo" >
        <div class="wrapper wrapper--w680">
               <div class="card card-1">
                ...
                <div class="card-body">
                   <center><h4 class="title">Enquiry Registration Form</h4></center> 
                    <form method="POST" action="">
                        ...
                        <div class="input-group">
                           ...
                           <div class="input-group">
                            <input required="required" class="input-style-2" type="email" placeholder="PROPER EMAIL *" name="email" id="email" >
                        </div>
                          
                          <div class="input-group">
                            <input required="required" class="input-style-2" type="text"  placeholder="MOBILE NO. *" name="mob" id="mobile" >
                        </div>
                                <div class="input-group">
                        ...
                        <div class="input-group" required="required">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="jobtype" id = "jobtype">
                                    <option disabled="disabled" selected="selected">ANY WORK TYPE </option>
                         ...
                         <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="ENTER STUDENT CATEGORY" name="desc"  id ="cd">
                        </div>
                        <div class="input-group">
                            <input required="required" class="input-style-2" type="text" placeholder="ENTER YOUR ENQUIRY " name="enquiry"  id="enqury" >
                        </div>
        ...
        //	url: "/sendtocontroller",
           ...
           // data: JSON.stringify(formData),
            ...
            success: function(response) {
            	swal("Successfully Inserted Recored");
